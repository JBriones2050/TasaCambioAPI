...
namespace Reference
{
    ...
    [System.ServiceModel.ServiceContractAttribute(Namespace="http://servicios.bcn.gob.ni/", ConfigurationName="Reference.Tipo_Cambio_BCNSoap")]
    public interface Tipo_Cambio_BCNSoap
    {
        ...
        System.Threading.Tasks.Task<Reference.RecuperaTC_MesResponse> RecuperaTC_MesAsync(Reference.RecuperaTC_MesRequest request);
    }
    ...
    public partial class RecuperaTC_MesRequest
    {
        ...
        public Reference.RecuperaTC_MesRequestBody Body;
        
        public RecuperaTC_MesRequest()
        {
        }
        
        public RecuperaTC_MesRequest(Reference.RecuperaTC_MesRequestBody Body)
        {
            this.Body = Body;
        }
    }
    ...
    public partial class RecuperaTC_MesResponse
    {
        ...
        public Reference.RecuperaTC_MesResponseBody Body;
        
        public RecuperaTC_MesResponse()
        {
        }
        
        public RecuperaTC_MesResponse(Reference.RecuperaTC_MesResponseBody Body)
        {
            this.Body = Body;
        }
    }
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.1.0")]
    public interface Tipo_Cambio_BCNSoapChannel : Reference.Tipo_Cambio_BCNSoap, System.ServiceModel.IClientChannel
    {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.1.0")]
    public partial class Tipo_Cambio_BCNSoapClient : System.ServiceModel.ClientBase<Reference.Tipo_Cambio_BCNSoap>, Reference.Tipo_Cambio_BCNSoap
    {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.Threading.Tasks.Task<Reference.RecuperaTC_MesResponse> Reference.Tipo_Cambio_BCNSoap.RecuperaTC_MesAsync(Reference.RecuperaTC_MesRequest request)
        {
            return base.Channel.RecuperaTC_MesAsync(request);
        }
        
        public System.Threading.Tasks.Task<Reference.RecuperaTC_MesResponse> RecuperaTC_MesAsync(int Ano, int Mes)
        {
            Reference.RecuperaTC_MesRequest inValue = new Reference.RecuperaTC_MesRequest();
            inValue.Body = new Reference.RecuperaTC_MesRequestBody();
            inValue.Body.Ano = Ano;
            inValue.Body.Mes = Mes;
            return ((Reference.Tipo_Cambio_BCNSoap)(this)).RecuperaTC_MesAsync(inValue);
        }
